...
[
  ...
  new-bacteria-from-proliferation ; a counter to keep track of new bacteria from proliferation in the current tick
  total-new-bacteria-from-proliferation ; a counter to keep track of all new bacteria from proliferation throughout the simulation
  total-number-of-eaten-bacteria ; counter used to keep track of the number of bacteria ever eaten since the start fo the simulation
  number-of-eaten-bacteria ; a counter used to keep track of the number of bacteria eaten by neutrophils and macrophages at the current tick
  total-number-of-bacteria-ever ; a counter used to keep track of how many bacteria have entered the wound since the start of the simulation
  percent-of-total-eaten-bacteria ; percentage of how many bacteria that have entered the wound have been eaten
  percent-of-eaten-bacteria ; percentage of bacteria eaten in the current tick
...
to Run-Simulation
  ...
  set total-number-of-bacteria-ever total-number-of-bacteria-ever + count bacteria
  set percent-of-total-eaten-bacteria (total-number-of-eaten-bacteria) * 100 / (total-number-of-bacteria-ever)
  if count bacteria > 0
  [
    set percent-of-eaten-bacteria (number-of-eaten-bacteria) * 100 / (count bacteria)
  ]
  set clock clock + 1
  tick
...
to proliferate-bacteria         ; this sub-routine simulates cell proliferation without any contact inhibition  [
  set new-bacteria-from-proliferation 0
  ask bacteria [
      ...
      [
        ...
        set new-bacteria-from-proliferation new-bacteria-from-proliferation + 1
        set total-new-bacteria-from-proliferation total-new-bacteria-from-proliferation + 1
        ]
      ]
    ]
end
...
to Leukocyte-Actions
  set number-of-eaten-bacteria 0
  ask neutrophils [if any? bacteria-on patch-here
    [
      ...
      set number-of-eaten-bacteria number-of-eaten-bacteria + 1
      set total-number-of-eaten-bacteria total-number-of-eaten-bacteria + 1
    ]
...
621
488
Percentage of Bacteria Eaten (At Each Tick)
Time (Hours)
Percent (%)
0.0
10.0
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot percent-of-eaten-bacteria"
...
623
648
Percent of Bacteria Eaten (Cumulative)
Time (Hours)
Percent (%)
0.0
10.0
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plot percent-of-total-eaten-bacteria"
